odoo.define('crm.lead.SystrayMenu', function(require) {
   "use strict";
...
var ActivityMenu = Widget.extend({
    ...
    _updateActivityPreview: function () {
        ...
        self._getActivityData().then(function (){
            self._$activitiesPreview.html(QWeb.render('crm.lead.SystrayMenu.Previews', {
